...
if (
  ...
  seenBy: [req.user._id],
   ...
   chat.lastMessage = message._id;
    ...
    // =========================
    // AI TASK DETECTION
    // Only runs when the SENDER has it enabled on their own account.
    // Detected tasks belong to the sender (their own reminder/to-do).
    // =========================
    if (req.user.aiTaskDetectionEnabled && text) {
      try {
        ...
        // Task detection failing should never break message sending

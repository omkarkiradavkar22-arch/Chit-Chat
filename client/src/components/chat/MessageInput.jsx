...
const handleAudioEnded = () => {
  ...
  return (
    <div className="border-t bg-white p-4">
      ...
      {isRecording && (
        <div className="mb-3 flex items-center gap-3 bg-red-50 px-4 py-3 rounded-xl">
  ...
  <div className="mb-3 flex items-center gap-3 bg-blue-50 border border-blue-200 px-4 py-3 rounded-xl">

...
const handlePrivacy = async () => {
  ...
  return (
    <Layout>
      <div className="max-w-xl mx-auto bg-white dark:bg-gray-900 text-gray-900 dark:text-white rounded-2xl shadow p-6 mt-8">
  ...
  />
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-lg p-3 mt-2 outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
